...
public final class ChineseCharToEn {
	...
	public static void main(String[] args) {
		...
		System.out.println("'Javer夜未眠'的首个拼音字母是："
				+ cte.getFirstLetter("Javer夜未眠"));

		System.out.println("'期望值为供销社'的全部字母的拼音字母是："
				+ cte.getAllFirstLetter("期望值为供销社"));
